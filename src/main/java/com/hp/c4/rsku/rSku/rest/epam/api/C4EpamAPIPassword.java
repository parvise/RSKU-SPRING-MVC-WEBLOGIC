...
public class C4EpamAPIPassword {
	...
	private static Logger mLogger = Logger.getLogger(C4EpamAPIPassword.class);
	...
	private static String EPAM_C4_API_KEY_STORE_FILE = "epam.api.keystore.file.jks.location";
	...
	//LOCAL
	//private static final String PATH = "D:/Pervez/C4/RSKU_Project/epam_config.properties";
	...
	public static String getEpamApiPaswword(Map<String, String> epamAPIMap) throws APIException {
		...
		mLogger.info("Connecting to External API...... For EPAM Authentication........Started ...." );
