...
public class C4EpamApi {
	...
	// Samples/ITG/epam_config.properties";

	// PRO
	// private static final String PATH = "D:/Pervez/C4/EPAM/API
	// Samples/PRO/epam_config.properties";
	// D:/Pervez/C4/RSKU_Project/epam_config.properties
	static {
		try {
			...
			while (enum0.hasMoreElements()) {
				...
				mLogger.debug("TEsting.." + key + ":" + prop.getProperty(key));
			}
