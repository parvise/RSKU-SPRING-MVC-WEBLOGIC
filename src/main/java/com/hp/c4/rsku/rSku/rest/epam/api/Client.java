...
public class Client {
	 ...
	 * @throws Client.APIException
	 */
	public String immediatePasswordRequest(int accountId, int systemId, int duration, String reason)
			throws Client.APIException {
		String body = String.format("{\"AccountId\":%d,\"SystemId\":%d,\"DurationMinutes\":%d,\"Reason\":%s}",
				accountId, systemId, duration, jsonString(reason));
